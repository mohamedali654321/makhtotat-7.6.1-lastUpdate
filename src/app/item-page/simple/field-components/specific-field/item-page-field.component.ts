...
export class ItemPageFieldComponent {
    ...
    ngOnInit(): void {
      ...
      || this.fields.includes('dc.description.statementofresponsibility') || this.fields.includes('dc.description.isversionof') || this.fields.includes('dc.description.referrals')
       ) 
