...
@Component({
  selector: 'ds-item-group-search-result-list-element',
  styleUrls: ['./item-group-search-result-list-element.component.scss'],
  templateUrl: './item-group-search-result-list-element.component.html'
})
/**
 * The component for displaying a list element for an item search result of the type Publication
 */
export class GroupSearchResultListElementComponent extends SearchResultListElementComponent<ItemSearchResult, Item> {
  relationShips;
