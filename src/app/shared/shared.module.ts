...
// import { LoadingFileComponent } from './kware-media-viewer/shared/loading-file/loading-file.component';
...
import { ItemGroupSearchResultGridElementComponent } from './object-grid/search-result-grid-element/item-search-result/item-group/item-group-search-result-grid-element.component';
import { GroupGridElementComponent } from './object-grid/item-grid-element/item-types/group/group-grid-element.component';
import { GroupListElementComponent } from './object-list/item-list-element/item-types/group/group-list-element.component';
import { GroupSearchResultListElementComponent } from './object-list/search-result-list-element/item-search-result/item-types/item-group/item-group-search-result-list-element.component';
...
const COMPONENTS = [
  ...
  ItemGroupSearchResultGridElementComponent,
